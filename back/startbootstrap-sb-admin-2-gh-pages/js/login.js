...
function preloadInitiatives() {
    ...
    const predefinedInitiatives = [
        ...
        { id: 40, titulo: "Aula Solidária de Yoga", type: "Aulas", localidade: "Complexo Desportivo da Rodovia, Braga", region: "Lisboa", data: "2024-07-22", horaInicio: "07:00", horaFim: "09:00", descricao: "Descubra a paz interior e a flexibilidade na nossa aula de yoga, uma prática rejuvenescedora ao ar livre, ideal para alinhar corpo, mente e espírito.", imagem: "../../assets/6.jpg", participantes: [], doacoes: 0, materiais: [], profissionais: [], gestor: "s.thor@example.com", participantesmax: 100 }
    ];
