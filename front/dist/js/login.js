...
function preloadPedidos() {
    ...
    const predefinedPedidos = [
        ...
        { id: 8, estado: "aceite" ,email: "carlosjoao@example.com", titulo: "aceite", type: "Aulas", localidade: "Parque da Avenida", region: "Norte", data: "2024-04-24", horaInicio: "15:00", horaFim: "17:00", descricao: "Sessão de pilates ao ar livre para promover a saúde e o bem-estar.", imagem: "../../assets/pilates.jpg"}
    ];
